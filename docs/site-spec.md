...
2. **Autopilot** — $495/mo (anchor $849; Arya moved the price down from $649 and the anchor from $949 on 2026-07-05). Upfront `$0. We waive the $2,500 setup fee.` Term `Monthly. Cancel any time.` (30-days'-notice wording dropped at Arya's direction 2026-07-05.) Includes (bulleted list): everything in Growth · Google Business Profile · pages for each area you serve · review follow-ups · online booking · call tracking · a monthly report · Google **and Meta** ads run and tracked. (Ad-spend note removed at Arya's direction.) Guarantee `More leads within 90 days.` Pays for itself at about 2 jobs a month.
